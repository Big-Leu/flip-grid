...
class PaytmChecksum {
	...
	static encrypt(input, key) {
		...
		// console.log(" inside encrypt" , encrypted)
		return encrypted;
	}
	...
	static verifySignatureByString(params, key, checksum) {	
		...
		// console.log(PaytmChecksum.calculateHash(params, salt) ," \n" , paytm_hash , " \n" , (paytm_hash === PaytmChecksum.calculateHash(params, salt))	)
	...
	static getStringByParams(params) {
		...
		console.log(data)
		console.log(typeof(Object.values(data).join('|')));
